...
public struct LocationUpdateDTO: Codable {
    ...
    public init(name: String? = nil, address: String? = nil, isOutside: Bool? = nil, hasLights: Bool? = nil, needMembership: Bool? = nil, open24Hours: Bool? = nil, operatingHours: String? = nil, notes: String? = nil) {
        self.name = name
        self.address = address
        self.isOutside = isOutside
        self.hasLights = hasLights
